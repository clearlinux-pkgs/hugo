...
Source0  : https://github.com/gohugoio/hugo/archive/v0.74.1/hugo-0.74.1.tar.gz
...
%prep
%setup -q -n hugo-0.74.1
cd %{_builddir}
tar xf %{_sourcedir}/hugo-vendor-0.74.0.tar.xz
cd %{_builddir}/hugo-0.74.1
mkdir -p ./
cp -r %{_builddir}/hugo-vendor-0.74.0/* %{_builddir}/hugo-0.74.1/./
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594746519
...
cp %{_builddir}/hugo-0.74.1/LICENSE %{buildroot}/usr/share/package-licenses/hugo/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
cp %{_builddir}/hugo-0.74.1/docs/LICENSE.md %{buildroot}/usr/share/package-licenses/hugo/4a606a34022a7ef2eab88e43148dd48547d3c017
cp %{_builddir}/hugo-0.74.1/docs/content/en/about/license.md %{buildroot}/usr/share/package-licenses/hugo/0762264440482182008eccd281bcd674a208a2ed
...
cp %{_builddir}/hugo-vendor-0.74.0/vendor/github.com/evanw/esbuild/LICENSE.md %{buildroot}/usr/share/package-licenses/hugo/d11e36e13b219e0c0cb023a56eb6d411d136316a
...
cp %{_builddir}/hugo-vendor-0.74.0/vendor/github.com/getkin/kin-openapi/LICENSE %{buildroot}/usr/share/package-licenses/hugo/2a18e5d6827e59dd2179c5e191d8cfa92ad197d6
