...
Source0  : https://github.com/gohugoio/hugo/archive/v0.99.1/hugo-0.99.1.tar.gz
...
%prep
%setup -q -n hugo-0.99.1
cd %{_builddir}
tar xf %{_sourcedir}/hugo-vendor-0.99.0.tar.xz
cd %{_builddir}/hugo-0.99.1
mkdir -p ./
cp -r %{_builddir}/hugo-vendor-0.99.0/* %{_builddir}/hugo-0.99.1/./
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652895464
...
cp %{_builddir}/hugo-0.99.1/LICENSE %{buildroot}/usr/share/package-licenses/hugo/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
cp %{_builddir}/hugo-0.99.1/docs/LICENSE.md %{buildroot}/usr/share/package-licenses/hugo/4a606a34022a7ef2eab88e43148dd48547d3c017
cp %{_builddir}/hugo-0.99.1/docs/content/en/about/license.md %{buildroot}/usr/share/package-licenses/hugo/0762264440482182008eccd281bcd674a208a2ed
