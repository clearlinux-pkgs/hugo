...
%prep
%setup -q -n hugo-0.74.2
cd %{_builddir}
tar xf %{_sourcedir}/hugo-vendor-0.74.0.tar.xz
cd %{_builddir}/hugo-0.74.2
mkdir -p ./
cp -r %{_builddir}/hugo-vendor-0.74.0/* %{_builddir}/hugo-0.74.2/./
...
cp %{_builddir}/hugo-0.74.2/docs/LICENSE.md %{buildroot}/usr/share/package-licenses/hugo/4a606a34022a7ef2eab88e43148dd48547d3c017
cp %{_builddir}/hugo-0.74.2/docs/content/en/about/license.md %{buildroot}/usr/share/package-licenses/hugo/0762264440482182008eccd281bcd674a208a2ed
